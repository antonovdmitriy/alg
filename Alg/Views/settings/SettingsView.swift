                    ...
                    VStack(spacing: 12) {
                        HStack(spacing: 32) {
                            ...
                            Image("githubIcon")
                                ...
                                .onTapGesture {
                                    if let url = URL(string: "https://github.com/antonovdmitriy/alg/") {
                                        UIApplication.shared.open(url)
                                    }
                                }
                                .opacity(0.7)
                            ...
                            Image(systemName: "paperplane.fill")
                                ...
                                .contentShape(Rectangle())
                                .onTapGesture {
                                    if let url = URL(string: "https://t.me/swedishwords") {
                                        UIApplication.shared.open(url)
                                    }
                                }
                                .foregroundColor(colorScheme == .dark ? Color.white.opacity(0.7) : Color.primary)
                                .opacity(0.7)
